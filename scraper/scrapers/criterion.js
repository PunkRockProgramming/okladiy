/**
 * Scraper for The Criterion (Oklahoma City, OK) via Prekindle
 *
 * The Criterion uses Prekindle for ticketing and has a standard
 * Prekindle event calendar page with JSON-LD Event data.
 */

import * as cheerio from 'cheerio';
import { fetchHtml, normalizeShow } from '../utils.js';

const PREKINDLE_URL = 'https://www.prekindle.com/events/the-criterion';
const VENUE_NAME = 'The Criterion';
const VENUE_URL  = 'https://criterionokc.com';
